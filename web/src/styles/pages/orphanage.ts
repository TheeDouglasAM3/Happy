...
export const Container = styled.div`
  ...
  .orphanage-details .orphanage-details-content button {
    margin-top: 8px;
  ...
  .orphanage-details .orphanage-details-content button svg {
    margin-right: 16px;
  }

  .orphanage-details .orphanage-details-content button.contact-whatsapp {
    background: #4ac959;
  }

  .orphanage-details .orphanage-details-content button.contact-whatsapp:hover {
    background: #36CF82;
  }

  .orphanage-details .orphanage-details-content button.contact-facebook {
    background: #3b5998;
  }

  .orphanage-details .orphanage-details-content button.contact-facebook:hover {
    background: #557ed6;
  }

  .orphanage-details .orphanage-details-content button.contact-website {
    background: #a7a7a7;
  }

  .orphanage-details .orphanage-details-content button.contact-website:hover {
    background: #b8b8b8;
  }
